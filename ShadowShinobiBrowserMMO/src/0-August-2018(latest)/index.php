...
function showchar() {
    ...
    $embaixo = "<center><font color=\"white\">Link do Personagem:</font><br><input type=\"text\" size=\"20\" value=\"http://nigeru.com/shadowshinobi/mostrarchar.php?nomechar=".$userrow["charname"]."\"></center>";
