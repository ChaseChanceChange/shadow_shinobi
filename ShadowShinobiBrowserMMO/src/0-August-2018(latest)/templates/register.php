...
<section class="ss-card ss-account-form ss-register" aria-labelledby="ss-register-title">
  ...
  <form action="register.php" method="post" class="ss-account-form__fields">
    <div class="ss-form-section">
      ...
      <div class="ss-form-field"><label for="email1">Email address</label><input id="email1" type="email" name="email1" value="{{email1value}}" size="30" maxlength="100" autocomplete="email" required /></div>
      <div class="ss-form-field"><label for="email2">Confirm email</label><input id="email2" type="email" name="email2" value="{{email2value}}" size="30" maxlength="100" autocomplete="email" required /></div>
    </div>
    <div class="ss-form-section">
      <h3>Character</h3>
      <div class="ss-form-field"><label for="charname">Character name</label><input id="charname" type="text" name="charname" value="{{charnamevalue}}" size="30" maxlength="30" autocomplete="off" required /></div>
    ...
    <div class="buttons ss-action-card__actions">
      <button type="submit" class="positive" name="register_submit" value="1"><img src="layoutnovo/dropmenu/b1.gif" alt=""> Create account</button>
