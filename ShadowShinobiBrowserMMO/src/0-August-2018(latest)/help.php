...
Em primeiro lugar, eu gostaria de dizer obrigado por jogar nosso jogo(em nome de toda comunidade Nigeru). O sistema de jogo Shadow Shinobi ? o resultado de v?rios meses de planejamento, codifica??o e testes. A id?ia original era criar um jogo baseado no universo do anime naruto. Na sua forma atual, apenas o nome dos personagens e suas propriedades realmente se assemelha ao jogo. Mas voc? ainda tomar? o conhecimento que parte da maioria das informa??es s?o f?cticias.
