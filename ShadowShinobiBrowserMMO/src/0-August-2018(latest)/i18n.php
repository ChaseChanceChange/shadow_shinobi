...
function ui_en($text) {
    ...
    if ($map === null) {
        $map = array(
            ...
            // Training / exploration franchise terminology -> Shadow terminology.
            'Jutsu de Busca' => 'Search Art',
            'Utilização do Jutsu de Busca.' => 'Use the Search Art.',
            'Possuir o Byakugan como Jutsu Ocular.' => 'Possess Essence Sight.',
            'Vila da Areia.' => 'Sand Enclave.',
            'Vila da Folha' => 'Blackleaf Enclave',
            ...
            'Montanha Myoboku.' => 'Myoboku Range.',
            'Myoboku' => 'Warden Range',
            'Byakugan' => 'Essence Sight', 'Senjutsu' => 'Essence Discipline',
            'Kage' => 'Warden', 'Ninja' => 'Operative', 'ninjas' => 'operatives', 'Ninja(s)' => 'Operative(s)',
            ...
            'Chat do Mapa' => 'Local Channel', 'Realizar Troca' => 'Trade', 'Resgatar Drop' => 'Recover',
            'Abrir Banco' => 'Open Vault', 'Fazer Login' => 'Log In', 'Sair do jogo' => 'Logout',
            'Complete os campos abaixo corretamente:' => 'Complete the fields below:',
            'Apagar Campos' => 'Clear Fields', 'Doar' => 'Transfer', 'Enviar' => 'Send',
            'Escolha' => 'Choose', 'Para:' => 'To:', 'Quantidade de Ryou:' => 'Coin amount:',
            'Doar Para(Nome do Jogador):' => 'Transfer to (operative name):',
            'Completar Missão' => 'Complete Contract', 'Treinar' => 'Develop',
            'Restar' => 'Remaining',
