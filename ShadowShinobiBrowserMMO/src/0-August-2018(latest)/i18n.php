...
function ui_en($text) {
    ...
    if ($map === null) {
        $map = array(
            ...
            'Training' => 'Discipline', 'Find Player' => 'Find Operative', 'Player' => 'Operative',
            'Players' => 'Operatives', 'Player(s) on Map.' => 'Operative(s) in Area.',
            'Map Options' => 'World Map Options', 'Map Chat' => 'Local Channel', 'Map' => 'World Map',
            'Character' => 'Operative Record', 'Characters' => 'Operatives',
